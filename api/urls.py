...
from .views import (
    ...
    UserProfileAPIView, api_login, api_signup, get_hobbies, send_friend_request, accept_friend_request, fetch_friend_requests, list_users, eligible_for_friend_requests
)
